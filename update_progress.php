...
$sql = "INSERT INTO user_progress (user_id, lesson_id, watch_time, start_time, last_activity)
        VALUES (?, ?, ?, ?, ?)
        ON DUPLICATE KEY UPDATE watch_time = watch_time + VALUES(watch_time), last_activity = VALUES(last_activity)";

$stmt = $conn->prepare($sql);
$stmt->bind_param("iiiss", $user_id, $lesson_id, $watch_time, $start_time, $last_activity);
$result = $stmt->execute();
